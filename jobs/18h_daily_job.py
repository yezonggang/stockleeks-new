...
def stock_a(code):
    ...
    # print(type(code))
    # 上证A股  # 深证A股
    if code.startswith('600') or code.startswith('6006') or code.startswith('601') or code.startswith('000')\
            or code.startswith('001') or code.startswith('002'):
        return True
    else:
        return False
# 过滤掉 st 股票。
...
def stat_all(tmp_datetime):
    ...
    try:
        ...
        print("################ block trading tmp_datetime : " + datetime_str)
